...
<body>
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
        <li  class="menu-active"><a href="clgwelcome.php">College Home</a></li>
          <li ><a href="clgstulist.php">Student List</a></li>
  ...
  <div class="card-body">
    <h5 class="card-title"><b>College Name: <?php echo $uname;  ?></b></h5>
    <p class="card-text"><b>Institue Code: </b><?php echo $name;  ?></p>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item"><b>College address:</b> <?php echo $cname;  ?></li>
...
body {
  background-image: url("https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80");
