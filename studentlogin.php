      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a href="home.php">Home</a></li>
			...
			<li ><a href="clglogin.php">College Login</a></li>
			...
			<div class="login-box">
		<img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" class="avatar" alt="Image Not Found">
        <h2><b>Student</b></h2>
        <form action="#" method="POST">
			<br>
            <p> Username  </p> 
            <input type="text" name="user" id="user" placeholder="Enter Username ID" autocomplete="off">
			<br><br>
            <p> Password </p>
